...
thischeck <- function() {
    test_that("sites_by_species works as expected", {
        skip_on_cran()
        skip("not sure which web service on NBN this should use - use occurence function instead?- function not currently exported in NBN4R")
...
thischeck = function() {
  test_that("sites_by_species arguments in NBN4R package match arguments in ALA4R package", {
