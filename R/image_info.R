...
#' @param image_number character or numeric: ID numbers of images (e.g. as returned by SBDI's image search at \url{https://images.nbnatlas.org/}. Each image_number will be of a format something like 122218480
