...
download_to_file <- function(url,outfile,binary_file=FALSE,caching=sbdi_config()$caching,verbose=sbdi_config()$verbose,on_redirect=NULL,on_client_error=NULL,on_server_error=NULL,...) {
